...
//				CartProductDTO[].class);
		...
		CartProductDTO[] cartProductDTOsResponse = webClient.get()
				.uri("http://localhost:3335/customercart-api/customer/" + order.getCustomerEmailId() + "/products")
				.retrieve()
	...
	CartProductDTO[] cartProductDTOs = cartProductDTOsResponse;
//		template.delete(
//				"http://CartMS/Ekart/customercart-api/customer/" + order.getCustomerEmailId() + "/products");
		
//		webClient.delete()
//						.uri("http://localhost:3335/Ekart/customercart-api/customer/" + order.getCustomerEmailId() + "/products")
//						.retrieve()
...
//				template.put("http://CartMS/Ekart/product-api/update/"
//						+ orderedProductDTO.getProduct().getProductId(), orderedProductDTO.getQuantity());
				...
				webClient
				 .put()
				.uri("http://localhost:3335/product-api/update/" + orderedProductDTO.getProduct().getProductId())
				.retrieve()
				.bodyToMono(Void.class)
				.block();
